...
header_text = "Así como estas flores amarillas, tu sinceridad trae luz y alegría a mi corazón en cada momento muchas gracias March"
color("white")  # COLOR DEL TEXTO
penup()
goto(-360, 180)  # POSICIÓN DEL TEXTO
pendown()
